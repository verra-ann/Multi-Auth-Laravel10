...
@section('indexSeller')
<body class="relative h-screen overflow-hidden bg-gray-100 dark:bg-gray-800 rounded-2xl">
    <div class="flex items-start justify-between">
        <div class="relative hidden h-screen my-4 ml-4 shadow-lg lg:block w-80">
            <div class="h-full bg-white rounded-2xl dark:bg-gray-700">
                ...
                <nav class="mt-6">
                    <div>
                        <a href="" class="flex items-center justify-start w-full p-4 my-2 font-thin text-blue-500 uppercase transition-colors duration-200 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 dark:from-gray-700 dark:to-gray-800" href="#">
                        ...
                        {{-- <a href="" class="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500">
                            <span class="text-left">
        ...
        <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4">
            ...
            <h3 class="text-white">Login User Name : {{ Auth::guard('seller')->user()->name }}</h3>
            <h3 class="text-white">Login User Email : {{ Auth::guard('seller')->user()->email }}</h3>
                    ...
                    <div class="relative flex items-center w-full pl-1 lg:max-w-68 sm:pr-2 sm:ml-0">
                        <div class="container relative left-0 z-50 flex w-3/4 h-auto h-full">
                            ...
                            <div class="relative flex items-center justify-end w-1/4 p-1 ml-5 mr-4 sm:mr-0 sm:right-auto" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">>
                                ...
                                <a href="{{ route('seller.logout') }}" method="get" class="block block px-4 py-2 text-md text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-100 dark:hover:text-white dark:hover:bg-gray-600" role="menuitem">
